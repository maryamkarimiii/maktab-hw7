...
public class MedicineRepository {
    ...
    public List<Medicine> getMedicines(int id) throws SQLException {
        ...
        while (resultSet.next()) {
            Medicine medicine = new Medicine(resultSet.getString(2), resultSet.getString(3), resultSet.getString(4),
                    resultSet.getInt(8), resultSet.getBoolean(5), resultSet.getBoolean(6),
